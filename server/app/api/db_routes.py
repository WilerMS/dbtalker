...
async def list_databases(
    ...
    return await database_controller.list_databases()
...
async def get_database_by_id(
    ...
    return await database_controller.get_database(database_id)
...
async def update_database_endpoint(
    ...
    return await database_controller.update_database(database_id, input_data)
...
async def delete_database_endpoint(
    ...
    await database_controller.delete_database(database_id)
